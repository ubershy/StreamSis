 ...
 */
package com.ubershy.streamsis.gui.controllers.editor.parts;
...
public class TargetImageWithActionsController extends AbstractCuteController
    ...
    /** The {@link TargetImageWithActions} to edit. */
	protected TargetImageWithActions tiwa;
	
	/** The original {@link TargetImageWithActions} to compare values with {@link #tiwa}. */
	protected TargetImageWithActions origTiwa;
	...
	public void bindToCuteElement(CuteElement editableCopyOfCE, CuteElement origCE) {
		tiwa = (TargetImageWithActions) editableCopyOfCE;
		origTiwa = (TargetImageWithActions) origCE;
		bindBidirectionalAndRemember(targetTextField.textProperty(),
				tiwa.targetImagePathProperty());
	}
