...
import com.ubershy.streamsis.elements.counters.regional.RegionTargetCounter;
...
public class RegionTargetCounterController extends AbstractCuteController
		implements CuteElementController, EventObserver {
	// TODO: fix duplicate code shared with RegionCheckerController.
    ...
    /** The {@link RegionTargetCounter} to edit. */
	protected RegionTargetCounter regCounter;
	
	/** The original {@link RegionTargetCounter} to compare values with {@link #regCounter}. */
	protected RegionTargetCounter origRegCounter;
	...
	public void bindToCuteElement(CuteElement editableCopyOfCE, CuteElement origCE) {
		regCounter = (RegionTargetCounter) editableCopyOfCE;
		origRegCounter = (RegionTargetCounter) origCE;
		bindBidirectionalAndRemember(targetTextField.textProperty(),
				regCounter.targetImagePathProperty());
		simController.bindToSimilarity(regCounter.similarityProperty(),
				origRegCounter.similarityProperty());
		coordsController.bindToCoordinates(regCounter.getCoords(), origRegCounter.getCoords());
	}
